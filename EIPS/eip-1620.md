...
ERC-1620 is a standard for a smart contract that enables and aggregates fixed-rate payments over a finite period of time.
...
Money as a function of time better aligns incentives in a host of scenarios, listed below. This standard helps end
users, wallet software developers and business alike in coordinating over a specific implementation
...
This is a preliminary list of use cases. There are other interesting ideas left to explore, such as time-dependent
mechanisms that dis-incentivise specific behaviours, but, for brevity, we have not included them here.

- Salaries, annuities, subscriptions, consultancies, insurance premiums, rent, lending
...
This specification is designed to serve as an entry point to the quirky concept of money as a function of time. Several
other designs, including payment channels have been considered, but we found them dense in unnecessary assumptions.
